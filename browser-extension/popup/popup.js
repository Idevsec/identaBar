    ...
    btnPing.addEventListener("click", async () => {
        ...
        try {
            ...
            if (chalRes.ok) {
                ...
                addLog(
                    `Registry challenge issued: ${challengeData.challenge.slice(0, 16)}... (${latency}ms)`,
                    "success"
                );
                ...
                if (endpoint) {
                    ...
                    try {
                        ...
                        addLog(
                            `Note: Extension CORS restrictions apply for localhost or unregistered domains.`,
                            "info"
                        );
