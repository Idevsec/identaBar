(function (root, factory) {
    ...
    try {
      ...
      if (typeof process !== 'undefined' && process.versions && process.versions.node) {
        ...
        if (publicKey.startsWith('ed25519:')) {
          ...
          var oidHeader = Buffer.from([0x30, 0x2a, 0x30, 0x05, 0x06, 0x03, 0x2b, 0x65, 0x70, 0x03, 0x21, 0x00]);
  ...
  function fetchAndVerifyRegistryAttestation(agentId, registryUrl) {
    var cleanAgentId = agentId.startsWith('agent:/') && !agentId.startsWith('agent://')
    ...
    return fetchHttpText(attestUrl)
      ...
      .then(function (pubKey) {
        ...
        // 4. Verify signature
        return verifyEd25519Signature(attestationDoc, attestationDoc.signature, pubKey)
          .then(function (signatureVerified) {
